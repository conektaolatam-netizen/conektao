...
create policy "Users can access expenses in their restaurant"
  on public.expenses
  for all
  using (
    exists (
...
create policy "Users can access expense items in their restaurant"
...
create policy "Users can only see their own expense items"
  on public.expense_items
  for all
  using (
    exists (
