...
const AliciaExperience = () => {
  ...
  return <div className="min-h-screen p-4 md:p-8 pt-20">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6 lg:gap-8">
          ...
          delay: 0.4
            ...
            <div className="bg-white border-t border-[#5C4033]/10 p-3">
              <div className="flex gap-2">
                <input disabled placeholder="Escribe naturalmente..." className="flex-1 px-4 py-2 rounded-full bg-[#F5F0E8] text-[#5C4033] text-sm border border-[#5C4033]/10" />
                <Button disabled className="rounded-full bg-gradient-to-r from-[#FF6B35] to-[#F7931E]" size="icon">
                  <Send className="w-4 h-4" />
                </Button>
              </div>
            </div>
        ...
        <AnimatePresence>
          ...
          y: 30
              ...
              <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
                <Button onClick={startDemo} variant="outline" className="border-[#5C4033]/20 text-[#5C4033]">
                  <RotateCcw className="w-4 h-4 mr-2" />
                  Repetir Demo
                </Button>
                <Button onClick={() => setIsFlipped(!isFlipped)} className="bg-gradient-to-r from-[#FF6B35] to-[#2DD4BF] text-white">
                  Ver Flujo Backend →
                </Button>
              </div>
            </motion.div>}
