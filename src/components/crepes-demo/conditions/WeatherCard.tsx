...
import { Cloud, Sun, CloudRain, CloudSnow, CloudLightning, Droplets, TrendingUp, TrendingDown } from 'lucide-react';
        ...
        <CardContent className="p-6">
          ...
          <div className="grid grid-cols-2 gap-3 mb-4">
            <div className={`p-3 rounded-lg border ${weather.salesImpact.dineIn >= 0 ? 'bg-emerald-50 border-emerald-200' : 'bg-rose-50 border-rose-200'}`}>
              ...
              <p className={`text-lg font-bold ${weather.salesImpact.dineIn >= 0 ? 'text-emerald-600' : 'text-rose-600'}`}>
            ...
            <div className={`p-3 rounded-lg border ${weather.salesImpact.delivery >= 0 ? 'bg-emerald-50 border-emerald-200' : 'bg-rose-50 border-rose-200'}`}>
              ...
              <p className={`text-lg font-bold ${weather.salesImpact.delivery >= 0 ? 'text-emerald-600' : 'text-rose-600'}`}>
