      ...
      <div className="p-5 space-y-5">
        ...
        <div>
          ...
          <div className="flex gap-2">
            <Input value={newRule} onChange={e => setNewRule(e.target.value)} placeholder="Ej: Si piden Camarones, preguntar: pizza, entrada o fettuccine?" onKeyDown={e => e.key === "Enter" && addRule()} className="border-border" />
