  ...
  return (
    <div className="bg-card border border-border/20 rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="p-5 space-y-5">
        <div>
          <label className="block text-sm font-medium text-foreground mb-1">¿Hay algo más que Alicia deba saber de tu negocio?</label>
          <p className="text-xs text-muted-foreground mb-2">Ejemplos: "Tenemos dos sedes", "No vendemos alcohol", "Solo abrimos fines de semana", "Tenemos carta secreta para clientes VIP"</p>
          <Textarea 
            value={info} 
          ...
          />
          <p className="text-xs text-muted-foreground mt-1 text-right">{info.length}/500</p>
        </div>
